...
class ParticipationTestCase(TestCase):
    ...
    def test_get_empty_user_participating(self):
    ...
    def test_get_user_participating(self):
        """Test the get_user_participating view"""
        self.login()
    ...
    def test_add_user_participating(self):
    ...
    def test_add_user_to_non_existent_event(self):
        """Test the add_user_participating view"""
        self.login()
        response = self.client.post(
            f'/attendance/3000/join')
        self.assertEqual(response.status_code, 404)
        self.assertEqual(response.json()['error'], 'Event not found')

    def test_add_user_to_old_event(self):
        """Test the add_user_participating view"""
        self.login()
        response = self.client.post(
    ...
    def test_add_user_to_already_joined_event(self):
        """Test the add_user_participating view"""
        self.login()
        Attendance.objects.create(
            user=self.user,
    ...
    def test_add_user_to_full_event(self):
